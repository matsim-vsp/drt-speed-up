 ...
 *
 */
public final class OpenBerlinIntermodalPtDrtRouterModeIdentifierWithDrtTeleportation implements MainModeIdentifier {
	private final List<String> modeHierarchy = new ArrayList<>() ;
	private final List<String> drtModes;

	@Inject
	public OpenBerlinIntermodalPtDrtRouterModeIdentifierWithDrtTeleportation() {
		...
		modeHierarchy.add( "drt_teleportation" ); // 
